...
function Hero({ isMobile }) {
  ...
  return (
    <section className="flex w-full flex-col items-center justify-evenly gap-8 py-6 md:h-auto md:gap-12 lg:h-screen lg:gap-6 lg:pt-[7.5rem] xl:pt-[9rem] 3xl:gap-12 3xl:pt-[11rem]">
